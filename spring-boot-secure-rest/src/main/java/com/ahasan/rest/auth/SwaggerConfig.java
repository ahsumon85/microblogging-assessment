...
public class SwaggerConfig {
	...
	public Docket salesApi() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.ahasan.rest.controller")).paths(PathSelectors.any())
...
//		authorizationScopes[2] = new AuthorizationScope("TRUSTED", "trust all");
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("SIMPLE MICROBLOGGING").description("Author by Ahasan Habib")
				...
				.license("Open Source").licenseUrl("https://github.com/ahsumon85/microblogging-assessment")
				.version("1.0.0").build();
