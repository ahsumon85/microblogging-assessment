...
public class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
			http.csrf().disable()
				...
				.authorizeRequests()
				.antMatchers(StaticUrlProvider.USER_URL + "/sing-up").permitAll()
				.antMatchers(StaticUrlProvider.BLOGGER_URL +"/find/post").permitAll()
				.antMatchers(StaticUrlProvider.USER_URL +"/find/user/info").permitAll()
				.and()
